    ...
    <>
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden lg:block">
              <button 
                ...
                className="bg-emerald-600 text-white px-6 py-2.5 rounded-lg font-semibold text-sm hover:bg-emerald-700 transition-colors duration-300 shadow-lg"
              >
                Get Quote
              </button>
            </div>
        ...
        <div className={`lg:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-lg mx-4 mt-4 rounded-xl">
            <div className="py-2">
              {NavLinks.map((link) => (
                <button
                  key={link.id}
